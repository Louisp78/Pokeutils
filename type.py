...
type_matrix[Type.FEU.value][Type.PLANTE.value] = 2
...
# PLANTE
type_matrix[Type.PLANTE.value][Type.FEU.value] = 0.5
type_matrix[Type.PLANTE.value][Type.POISON.value] = 0.5
type_matrix[Type.PLANTE.value][Type.PLANTE.value] = 0.5
type_matrix[Type.PLANTE.value][Type.VOL.value] = 0.5
type_matrix[Type.PLANTE.value][Type.INSECTE.value] = 0.5
type_matrix[Type.PLANTE.value][Type.DRAGON.value] = 0.5
type_matrix[Type.PLANTE.value][Type.ACIER.value] = 0.5
type_matrix[Type.PLANTE.value][Type.EAU.value] = 2
type_matrix[Type.PLANTE.value][Type.SOL.value] = 2
type_matrix[Type.PLANTE.value][Type.ROCHE.value] = 2

# ELECTRIK
type_matrix[Type.ELECTRIK.value][Type.SOL.value] = 0
type_matrix[Type.ELECTRIK.value][Type.PLANTE.value] = 0.5
...
type_matrix[Type.GLACE.value][Type.PLANTE.value] = 2
